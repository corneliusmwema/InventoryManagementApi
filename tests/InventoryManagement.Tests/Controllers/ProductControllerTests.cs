...
public class ProductControllerTests : IClassFixture<TestDatabaseFactory<Program>>
{
    ...
    private async Task SetupAuthenticationAsync()
    {
        ...
        try
        {
            ...
            if (string.IsNullOrEmpty(_authToken)) throw new InvalidOperationException("Auth token is null or empty");
    ...
    {
        // Arrange
        var nonExistentProductId = 999999; // Choose a very large ID that's unlikely to exist
