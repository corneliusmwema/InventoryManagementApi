...
public class ProductServiceTests
{
    ...
    public async Task GetAllProductsAsync_ShouldReturnAllProducts()
    {
        ...
        {
            new("Product 1", "Description 1", "Category 1", 10.00m, 100, 10),
            new("Product 2", "Description 2", "Category 2", 20.00m, 200, 20)
        };
    ...
    public async Task GetInventoryValuationAsync_ShouldReturnCorrectValuation()
    {
        ...
        var products = new List<Product>
        {
            new("Product 1", "Description 1", "Category 1", 10.00m, 10, 5),
            new("Product 2", "Description 2", "Category 2", 20.00m, 20, 10)
        };
        products[0].Id = 1;
        products[1].Id = 2;
    ...
    public async Task GetLowStockProductsAsync_ShouldReturnLowStockProducts()
    {
        ...
        var products = new List<Product>
        {
            new("Low Stock Product", "Description", "Category", 10.00m, 5, 10),
            new("Normal Stock Product", "Description", "Category", 20.00m, 20, 10)
        };
