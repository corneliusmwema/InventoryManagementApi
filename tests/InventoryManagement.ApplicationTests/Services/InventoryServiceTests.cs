...
public class InventoryServiceTests
{
    ...
    public InventoryServiceTests()
    {
        ...
        _inventoryService = new InventoryService(_mockInventoryTransactionRepository.Object,
            _mockProductRepository.Object, _mockLogger.Object);
    }
    ...
    public async Task GetTransactionHistoryForProductAsync_WhenProductExists_ShouldReturnTransactions()
    {
        ...
        {
            new(productId, TransactionType.Addition, 5, "Initial stock"),
            new(productId, TransactionType.Withdrawal, 2, "Order fulfillment")
        };
        transactions[0].Id = 1;
        transactions[1].Id = 2;
