...
public class InventoryService : IInventoryService
{
    ...
    public InventoryService(IInventoryTransactionRepository inventoryTransactionRepository,
        IProductRepository productRepository, ILogger<InventoryService> logger)
    {
