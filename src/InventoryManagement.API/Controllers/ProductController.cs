...

{
    ...
    public async Task<IActionResult> GetProductByIdAsync(int id)
    {
        try
        {
            ...
            _logger.LogInformation("Completed getting product with id {ProductId} in {Duration}", id,
    ...
    public async Task<IActionResult> UpdateProductAsync(int id, [FromBody] UpdateProductDto request)
    {
        try
        {
            ...
            _logger.LogInformation("Completed updating product with id {ProductId} in {Duration}", id,
                duration.TotalMilliseconds);
    ...
    public async Task<IActionResult> DeleteProductAsync(int id)
    {
        try
        {
            ...
            _logger.LogInformation("Completed deleting product with id {ProductId} in {Duration}", id,
                duration.TotalMilliseconds);
